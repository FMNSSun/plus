...
func (plus *PLUSConnManager) ProcessPacket(plusPacket *packet.PLUSPacket) ([]byte, error) {
	plus.mutex.Lock()
...
func (plus *PLUSConnManager) ReadAndProcessPacket() (*packet.PLUSPacket, net.Addr, []byte, error) {
